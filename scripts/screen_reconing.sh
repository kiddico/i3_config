...
then
	echo "1"
	xrandr --output eDP-1 --off --output DP-1 --off --output DP-2 --off --output DP-3 --off --output DP-4 --mode 3840x2160 --pos 0x0 --rotate normal --primary
...
then
	echo "2"
	xrandr --output eDP-1 --off --output DP-1 --off --output DP-2 --off --output DP-3 --mode 3840x2160 --pos 0x0 --rotate normal --primary --output DP-4 --off
	# 31.5" @ 3840x2160 = 139.87 PPI
	xrandr --dpi 120
